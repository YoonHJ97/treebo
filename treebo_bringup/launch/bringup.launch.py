...
def generate_launch_description():
    pkg_bringup = get_package_share_directory("treebo_bringup")
    ...
    declare_params = DeclareLaunchArgument(
        ...
        description="treebo_bringup parameters",
    )
    ...
    declare_xacro = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory("treebo_description"),
            "urdf",
            "robot.urdf.xacro",
        ),
    ...
    declare_use_odom = DeclareLaunchArgument(
        "use_odom",
        default_value="true",
        description="Start treebo_odom odom_publisher (/odom + TF odom->base_link)",
    )
